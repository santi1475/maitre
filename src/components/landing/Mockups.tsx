...
export function Mockups() {
  ...
  return (
    <section id="funciones" className="relative scroll-mt-20 overflow-hidden bg-cream py-20 dark:bg-[#111009] md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 text-center">
        <h2 className="font-serif text-3xl sm:text-4xl font-bold text-ink dark:text-[#e8e4dc] md:text-5xl">
          Todo el restaurante en una sola pantalla
        </h2>
        <p className="mx-auto mt-4 max-w-2xl font-sans text-base sm:text-lg text-stone">
          Desde que el cliente se sienta hasta que paga. Comandas, cocina y caja conectadas en vivo.
        </p>

        <div
          role="tablist"
          aria-label="Vistas del sistema"
          className="mx-auto mt-8 sm:mt-10 flex max-w-full items-center gap-1.5 sm:gap-2 overflow-x-auto rounded-xl bg-stone-light p-1.5 dark:bg-white/5 md:inline-flex md:justify-center md:overflow-visible"
        >
          {TABS.map((t, i) => {
            ...
            return (
              <button
                ...
                className={
                  isActive
                    ? "shrink-0 rounded-lg bg-primary px-3.5 sm:px-4 py-2 font-sans text-xs sm:text-sm font-bold text-white shadow-xs transition-colors"
                    : "shrink-0 rounded-lg px-3.5 sm:px-4 py-2 font-sans text-xs sm:text-sm font-medium text-stone transition-colors hover:text-ink dark:hover:text-[#e8e4dc]"
                }
              >
                {t.label}
              </button>
        ...
        <div className="mx-auto mt-8 sm:mt-10 max-w-4xl">
          <div className="overflow-hidden rounded-2xl border-2 border-stone/20 bg-[#f0ede8] shadow-lg dark:bg-[#1e1c19]">
            <div className="flex h-9 items-center px-4 bg-ink/10 dark:bg-white/5 border-b border-stone/15 dark:border-white/5">
              <div className="flex gap-1.5">
                <span className="h-2.5 w-2.5 rounded-full bg-red-400/80" />
                <span className="h-2.5 w-2.5 rounded-full bg-amber-400/80" />
                <span className="h-2.5 w-2.5 rounded-full bg-primary/80" />
              </div>
              <div className="flex-1 text-center font-sans text-[11px] sm:text-xs font-semibold text-stone-dark dark:text-stone">
                {activeTab.title}
              </div>
            ...
            <div className="relative min-h-[440px] sm:min-h-[470px] md:aspect-[16/10] w-full overflow-hidden">
